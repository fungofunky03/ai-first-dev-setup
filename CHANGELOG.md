...
- `docs/prompt-templates-cheat-sheet.md` — quick fill-in-the-blank prompt
  scaffolds across bug fixes, feature implementation, refactoring, testing,
  documentation, performance, security, migrations, code review, and
  general-purpose tasks. Each section links to the fuller prompt in
  `prompts/` where one exists. Linked from `README.md` and
  `prompts/README.md`.
